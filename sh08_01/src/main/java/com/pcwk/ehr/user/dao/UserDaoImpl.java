...
public class UserDaoImpl implements UserDao {
	...
	/*
	 * JdbcTemplate을 사용하면 JDBC 연결, 
	 * Statement 준비, ResultSet 처리, 예외 처리 등을 일일이 작성하지 않고도 간단하게 데이터베이스 작업을 수행할 수 있습니다.
	 */
	...
	public int del(final UserVO inVO) throws SQLException {
		...
		//dbcTemplate.update DML(insert,update,delete)
		flag = this.jdbcTemplate.update(sb.toString(), args);
		LOG.debug("3.flag \n" + flag);
		//----------------------------------------------------------------------
		return flag;
